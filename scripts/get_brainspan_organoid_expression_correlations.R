...
artificial_tissue.sample_names<-read.delim("~/Dropbox (Personal)/3D_Neural_NBME:BrainSpan_analysis/samples_described_detail_sample_info.txt",stringsAsFactors = F)
